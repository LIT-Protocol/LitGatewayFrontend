  ...
  return (
    <div className={styles.main}>
      <div className={styles.body}>
        ...
        <Grid cols="1" className={styles.list} breakpoints={{
          s: {
            cols: 5
          },
          xs: {
          ...
          <GridItem>
            <div className={styles.segment}>
              <div>
                <h2>> 5 <Badge status="warning" label="cake" /></h2>
              </div>
              <h5>Requirement</h5>
            </div>
          </GridItem>
        ...
        <div className={styles.textBlock}>
          ...
          <Link className={styles.support} >Support <HelpCircleWithTooltip/></Link>
        </div>
        <div className={styles.text}>
          <h3>Requirement details</h3>
          <Text spacing="s">
            It is a long established fact that a reader will be distracted by the readable content of a page when looking at its <Link className={styles.link}>layout</Link>.
          </Text>
        </div>
      </div>
    </div>
