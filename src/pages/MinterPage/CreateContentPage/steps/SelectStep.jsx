...
const SelectStep = ({setStep}) => {
  ...
  return (
    <div className={styles.main}>
      <div className={styles.back} onClick={() => history.push('/minter')}><IconArrowLeft className={styles.backIcon} view="brand" /> Exit minter</div>
      <div className={styles.selectStep}>
        <h2 className={styles.title}>What would you like to do?</h2>
        <div className={styles.types}>
          <div className={styles.type} onClick={() => setStep('create')}>
            <div className={styles.btnBock}>
              ...
              <h5>Create a new NFT with locked content</h5>
            </div>
          </div>
          <div className={styles.type}>
              <div className={styles.btnBock}>
                ...
                <h5>Add locked content to an existing NFT</h5>
              </div>
            </div>
        </div>
      </div>
