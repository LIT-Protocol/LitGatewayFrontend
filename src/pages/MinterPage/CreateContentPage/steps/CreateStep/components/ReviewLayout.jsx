  ...
  return (
    <div className={styles.reviewStep}>
      ...
      <Grid cols="1" gap="xl" breakpoints={{
        ...
        <GridItem>
          <div className={styles.card}>
            ...
            <div className={styles.img}>
              <img className={styles.ImgPreview} src={publicCover?.length? URL.createObjectURL(publicCover[0]) : getImg()}/>
            </div>
            <div className={styles.mainContent}>
              <h4>{title}</h4>
              {description? (
                <Text className={styles.text} as="p" size="m" lineHeight="m" view="primary">{description}</Text>
              ): null}
            </div>
        ...
        <GridItem>
          <Badge className={styles.blockchain} size="l" status="success" label={blockChain.label}/>
      ...
      <div className={styles.bottom}>
        <Button className={styles.btn} label="Mint It!" size="l" onClick={() => setCreateStep('success')}/>
      </div>
    </div>
  )
}
