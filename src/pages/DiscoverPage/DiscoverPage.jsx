    ...
    <div className={styles.main}>
      <div className={styles.card} style={{backgroundImage: `url(${Background})`}}>
        <div className={styles.content}>
          ...
          <h1 className={styles.title} as='h1' inverted>Find your tribe <br/> and playground</h1>
        </div>
      ...
      <div className={styles.block}>
        <h2 className={styles.title}>Experinces we love</h2>
      ...
      <Grid cols="1" gap="xl" className={styles.smallCards} breakpoints={{
        ...
        <GridItem>
          <div className={styles.miniCard}>
            <div>
              <img src={Card1} alt=''/>
              <Link to="/app"><h2 className={styles.title}>Yield Farming Chat</h2></Link>
            </div>
